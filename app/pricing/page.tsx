...
export const metadata: Metadata = {
  ...
  description:
    "Access to blog, image, and video generators with flexible pricing options for individual creators to enterprise teams.",
  openGraph: {
    title: "CreaVibe Pricing - AI Content Creation Plans",
    description:
      "Access to blog, image, and video generators with flexible pricing options for individual creators to enterprise teams.",
    images: [
      {
        url: "/api/og?title=CreaVibe%20Pricing",
        width: 1200,
        height: 630,
        alt: "CreaVibe Pricing Plans",
      },
    ],
  },
}
            ...
            <div className="mx-auto max-w-3xl mt-12">
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent>
                    Yes, you retain full ownership of all content created using our platform. You can use the content
                    for commercial purposes, and we make no claims to ownership or copyright of the generated content.
                    However, we recommend reviewing and editing AI-generated content before publishing to ensure

...
export const metadata: Metadata = {
  ...
  description:
    "Create stunning content with our AI tools, publish with WebBooks, and manage your projects efficiently.",
  openGraph: {
    title: "CreaVibe - AI-Powered Content Creation Platform",
    description:
      "Create stunning content with our AI tools, publish with WebBooks, and manage your projects efficiently.",
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="relative aspect-video overflow-hidden rounded-xl lg:aspect-square">
                <Image
                  ...
                  alt="AI content creation platform showing a person working with creative visualizations"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  priority
                  placeholder="blur"
                  blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIwMCIgaGVpZ2h0PSI2MDAiIHZlcnNpb249IjEuMSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB4PSIwIiB5PSIwIiB3aWR0aD0iMTIwMCIgaGVpZ2h0PSI2MDAiIGZpbGw9IiNjY2NjY2MiLz48L3N2Zz4="
                />
              </div>
            </div>
          </div>

          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <div className="relative aspect-video overflow-hidden rounded-xl lg:aspect-square">
              ...
              <Image
                ...
                alt="AI Content Creation Features"
                fill
        ...
        <div className="container px-4 md:px-6 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            ...
            <div className="space-y-4 order-3 md:order-4">
              ...
              <p className="text-muted-foreground pl-14">
                Organize your content into projects and create beautiful WebBooks for publishing. Customize layouts, add
                interactive elements, and apply your branding for a professional presentation.
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
              ...
              <p className="text-muted-foreground pl-14">
                Integrate our content generation capabilities into your own applications using API tokens. Track usage,
                monitor performance, and analyze engagement with comprehensive analytics.
              </p>
            </div>
            <div className="relative aspect-video overflow-hidden rounded-xl">
              <Image
            ...
            <div className="space-y-4 order-7 md:order-8">
              ...
              <p className="text-muted-foreground pl-14">
                Collect feedback from team members and clients using our built-in feedback system. Track changes, manage
                versions, and iterate on your content to achieve the best results.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our platform offers powerful AI tools, seamless integrations, and developer-friendly APIs to streamline
                your workflow.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">

...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the CreaVibe team for support, partnerships, or feedback.",
  openGraph: {
    title: "Contact CreaVibe - Get in Touch",
    description: "Get in touch with the CreaVibe team for support, partnerships, or feedback.",
    images: [
      {
        url: "/api/og?title=Contact%20CreaVibe",
        width: 1200,
        height: 630,
        alt: "Contact CreaVibe",
      },
    ],
  },
}
